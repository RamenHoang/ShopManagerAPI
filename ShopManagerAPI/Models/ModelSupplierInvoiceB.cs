...
{
    [Table(Name = "SupplierInvoice_B")]
    public class ModelSupplierInvoiceB
    {
        ...
        [Association(Name = MyConst.FK_SUPPLIERINVOICEB_TO_SUPPLIER, Storage = "_Supplier", IsForeignKey = true, ThisKey = "IdSupplier")]
